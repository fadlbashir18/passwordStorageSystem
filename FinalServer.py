...
import socket
from _thread import *
from random import randint #Only going to use in case needed for the encryption algorithm
...
#Open file for writing (probably not going to use it)
file = open("messagesFile", "w")
file.write("0")
file.close()

#Just a print statement showing that the server is still waiting for a connection from the client
